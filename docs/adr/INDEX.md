...
| [0003](./0003-local-identity-registry.md) | Local Identity Registry Over Custom IdP Claims | Accepted | 2026-08-03 |
...
0002  Dual Principal Model (M2M vs Human)
  │
  ├── 0003  Local Identity Registry          (how each principal is resolved)
  │     │
